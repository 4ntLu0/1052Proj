...
def spongebob_theme():
	...
	sponge_bob_melody = [
		...
		notes['F5'],notes['E5'],notes['F5'],notes['D5'],notes['C5'],notes['D5'],notes['C5'],notes['A4'],notes['F4'],notes['A4'],notes['G5'],
		notes['F5'],notes['G5'],notes['F5'],notes['D5'],notes['B4'],notes['D5'],notes['F5'],notes['G5'],notes['F5'],notes['D5'],
		notes['B4'],notes['D5'],notes['F5'],notes['F5'],notes['D5'],notes['B4'],notes['B4'],notes['D5'],notes['F5'],notes['G5'],notes['A4'],
		notes['C5'],notes['G5'],notes['C5'],notes['A4'],notes['F4'],notes['A4'],notes['C5'],notes['G5'],notes['C5'],notes['A4'],
		notes['F5'],notes['E5'],notes['D5'],notes['C5'],notes['A4'],notes['F4'],notes['A4'],notes['G4'],notes['F4'],notes['A4'],notes['G5'],
		notes['F5'],notes['G5'],notes['F5'],notes['D5'],notes['B4'],notes['D5'],notes['F5'],notes['G5'],notes['F5'],notes['D5'],
